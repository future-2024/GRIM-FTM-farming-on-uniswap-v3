    ...
    <section id="workingArea">
      <div class="p-lg-1">
        <div v-if="welcome" class="row welcome">
          ...
          <p>
            To farm the precious GRIM coin you no longer have to visit multiple
              ...
              <template v-slot:body="props">
                ...
                >
                  ...
                  <q-td style="width: 200px">
                    ...
                    Staked : {{ props.row.stakedAmount }} (GRIM)
                  </q-td>
                  <q-td style="width: 150px">
                    <div class="label text-success">
                      {{ props.row.rewardAmount }} GRIM
                    </div>
                    Available reward
                  </q-td>
...
export default {
  ...
  computed: {
    getNFTInfo() {
      console.log('grim', this.$store.state.nftItem)
